...
CROP_CLASSES = ["Wheat", "Rice", "Maize", "Sugarcane", "Mustard","Cotten"]
...
st.markdown("<div class='title'>🌾 KhetPrithvi</div>", unsafe_allow_html=True)
...
st.sidebar.write(
    """
    👩‍🌾 **KhetPrithvi** helps identify crops using **satellite imagery**.  
    This demo uses a mock model for predictions.  
    Built for the **.
    """
)
st.sidebar.write("---")
st.sidebar.write("📌 Upload a farm image on the main screen to get predictions.")

# ----------------------------
# Upload Section
# ----------------------------
st.write("### 📤 Upload Satellite Image")
...
if uploaded_file is not None:
    ...
    # Prediction Section
    # ----------------------------
    st.write("### 🔍 Model Prediction (Demo)")
    ...
    with col2:
        st.markdown(
            ...
            <div class='prediction-box'>
                <h3>✅ Predicted Crop: <span style="color:#2e7d32">{pred_class}</span></h3>
    ...
    st.info("👆 Please upload a satellite image to start crop classification.")

# ----------------------------
# Footer
# ----------------------------
st.markdown("---")
#plt.bar(class_names, probs, color=['red','green','blue','yellow'])
